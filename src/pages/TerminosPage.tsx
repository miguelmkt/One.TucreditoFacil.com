...
import { brandColors, siteConfig } from '../config/siteConfig';
...
const termsContent: Record<string, TermsLang> = {
  es: {
    ...
    sections: [
      { id: 'uso', title: '1. Uso del Sitio', content: 'Este sitio web proporciona contenidos sobre finanzas personales, ahorro, inversión, tarjetas de crédito y préstamos únicamente con fines informativos. No constituye asesoría financiera personalizada. Para decisiones financieras importantes, consulte con un profesional autorizado.' },
      { id: 'contenido', title: '2. Propiedad del Contenido', content: 'Todo el contenido publicado en este sitio —artículos, gráficos, logos e imágenes— es propiedad de este sitio web y está protegido por las leyes de propiedad intelectual. No está permitida su reproducción sin autorización expresa por escrito.' },
        { id: 'exactitud', title: '3. Exactitud de la Información', content: `La información publicada en ${siteConfig.siteName} tiene carácter informativo y no constituye asesoría financiera personalizada. Para decisiones financieras importantes consulte con un profesional autorizado.` },
  ...
  pt: {
    ...
    sections: [
      { id: 'uso', title: '1. Uso do Site', content: 'Este site fornece conteúdos sobre finanças pessoais, poupança, investimento, cartões de crédito e empréstimos apenas para fins informativos. Não constitui aconselhamento financeiro personalizado. Para decisões financeiras importantes, consulte um profissional qualificado.' },
      { id: 'conteudo', title: '2. Propriedade do Conteúdo', content: 'Todo o conteúdo publicado neste site — artigos, gráficos, logotipos e imagens — é propriedade deste site e está protegido pelas leis de propriedade intelectual. Não é permitida sua reprodução sem autorização expressa por escrito.' },
        { id: 'exatidao', title: '3. Exatidão das Informações', content: `Todas as informações publicadas em ${siteConfig.siteName} têm caráter informativo e não constituem aconselhamento financeiro personalizado. Para decisões financeiras importantes, consulte um profissional qualificado.` },
  ...
  en: {
    ...
    sections: [
      { id: 'uso', title: '1. Use of the Site', content: 'This website provides content about personal finance, saving, investing, credit cards and loans for informational purposes only. It does not constitute personalized financial advice. For significant financial decisions, consult a qualified professional.' },
      { id: 'contenido', title: '2. Content Ownership', content: 'All content published on this site — articles, graphics, logos, and images — is the property of this website and is protected by intellectual property laws. Reproduction without express written authorization is not permitted.' },
        { id: 'exactitud', title: '3. Accuracy of Information', content: `All information published on ${siteConfig.siteName} is for informational purposes and does not constitute personalized financial advice. For significant financial decisions consult a qualified professional.` },
  ...
  fr: {
    ...
    sections: [
      { id: 'uso', title: '1. Utilisation du Site', content: "Ce site web fournit des contenus sur les finances personnelles, l'épargne, l'investissement, les cartes de crédit et les prêts à titre informatif uniquement. Il ne constitue pas un conseil financier personnalisé. Pour des décisions financières importantes, consultez un professionnel qualifié." },
      { id: 'contenido', title: '2. Propriété du Contenu', content: "Tout le contenu publié sur ce site — articles, graphiques, logos et images — est la propriété de ce site web et est protégé par les lois sur la propriété intellectuelle. La reproduction sans autorisation écrite expresse n'est pas autorisée." },
        { id: 'exactitud', title: '3. Exactitude des Informations', content: `Toutes les informations publiées sur ${siteConfig.siteName} sont à titre informatif et ne constituent pas un conseil financier personnalisé. Pour des décisions financières importantes, consultez un professionnel qualifié.` },
