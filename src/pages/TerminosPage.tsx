...
const termsContent: Record<string, TermsLang> = {
  es: {
    ...
    sections: [
      { id: 'uso', title: '1. Uso del Sitio', content: 'Este sitio web proporciona información financiera únicamente con fines educativos e informativos. No constituye asesoría financiera, inversión, legal o fiscal. Debes consultar a un profesional cualificado antes de tomar decisiones financieras importantes.' },
  ...
  pt: {
    ...
    sections: [
      { id: 'uso', title: '1. Uso do Site', content: 'Este site fornece informações financeiras apenas para fins educacionais e informativos. Não constitui assessoria financeira, de investimento, legal ou fiscal. Você deve consultar um profissional qualificado antes de tomar decisões financeiras importantes.' },
  ...
  en: {
    ...
    sections: [
      { id: 'uso', title: '1. Use of the Site', content: 'This website provides financial information for educational and informational purposes only. It does not constitute financial, investment, legal, or tax advice. You should consult a qualified professional before making important financial decisions.' },
  ...
  fr: {
    ...
    sections: [
      { id: 'uso', title: '1. Utilisation du Site', content: "Ce site web fournit des informations financières à des fins éducatives et informatives uniquement. Il ne constitue pas un conseil financier, d'investissement, juridique ou fiscal. Vous devez consulter un professionnel qualifié avant de prendre des décisions financières importantes." },
